...
/**
 * HumidityChart displays the relative humidity for the selected location
 * using a line chart.
 */
...
export default class HumidityChart extends React.Component {
    ...
    componentDidMount() {
      /**
       * This function fetches new relative humidity data when the component first mounts
       */
      var url = 'http://localhost:5000/humidity/<' + this.props.selectedLocation +'>'
        fetch(url)
        .then(res => res.json())
    ...
    componentDidUpdate(prevProps) {
      /**
       * This function fetches relative humidity data each time the user
    ...
    getLineOptions() {
       ...
       */
        ...
        const dataLocation = 'humidity_' + this.props.selectedLocation;       // used to get data from the fetched response
