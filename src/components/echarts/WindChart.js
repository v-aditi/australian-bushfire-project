...
/**
 * WindChart displays the rainfall for the selected location
 * using a line chart.
 */
export default class WindChart extends React.Component {
    ...
    componentDidMount() {
       /**
       * This function fetches new Wind Speed data when the component first mounts
       */
      var url = 'http://localhost:5000/wind/<' + this.props.selectedLocation +'>'
        fetch(url)
        .then(res => res.json())
    ...
    componentDidUpdate(prevProps) {
        /**
       * This function fetches new Wind Speed data each time the user selects a new
       * location
    ...
    getLineOptions() {
       ...
       */
        ...
        const dataLocation = 'wind_' + this.props.selectedLocation;  // used to get data from the fetched response
